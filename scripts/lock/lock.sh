...
# convert /tmp/screen.png -ordered-dither c5x5b /tmp/screen.png # Pixelate
...
[[ -f $1 ]] && convert /tmp/screen.png -scale 2.5% -scale 4000% $1 -gravity center -composite -matte /tmp/screen.png
